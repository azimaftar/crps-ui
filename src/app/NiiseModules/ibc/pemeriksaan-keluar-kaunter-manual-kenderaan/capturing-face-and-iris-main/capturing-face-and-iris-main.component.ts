...
@Component({
  selector: 'app-capturing-face-and-iris-main',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './capturing-face-and-iris-main.component.html',
  styleUrls: ['./capturing-face-and-iris-main.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapturingFaceAndIrisMainComponent {
