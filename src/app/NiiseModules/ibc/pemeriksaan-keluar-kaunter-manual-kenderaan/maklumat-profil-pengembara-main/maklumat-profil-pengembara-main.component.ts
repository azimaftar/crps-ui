...
@Component({
  selector: 'app-maklumat-profil-pengembara-main',
  ...
  templateUrl: './maklumat-profil-pengembara-main.component.html',
  styleUrl: './maklumat-profil-pengembara-main.component.scss'
})
export class MaklumatProfilPengembaraMainComponent {
  //ReactiveModule Form
  ...
  semakMaklumatPengembara() {
    ...
    this.router.navigate(['../maklumat-profil-semak-main'],  {relativeTo: this.route});
