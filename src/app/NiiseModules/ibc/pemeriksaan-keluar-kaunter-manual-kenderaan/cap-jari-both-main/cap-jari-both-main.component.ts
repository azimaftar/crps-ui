...
@Component({
  selector: 'app-cap-jari-both-main',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './cap-jari-both-main.component.html',
  styleUrls: ['./cap-jari-both-main.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapJariBothMainComponent {
...
OnOKButtonClick() {
  ...
  this.router.navigate(['../cap-jari-four-post-main'], {
