...
@Component({
  selector: 'app-maklumat-visa-main',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './maklumat-visa-main.component.html',
  styleUrl: './maklumat-visa-main.component.scss'
})
export class MaklumatVisaMainComponent implements OnInit {
  visaForm!: FormGroup;
