...
@Component({
  selector: 'app-maklumat-pas-main',
  imports: [
      CommonModule,
      ReactiveFormsModule,
      RouterModule,
  ...
  templateUrl: './maklumat-pas-main.component.html',
  styleUrl: './maklumat-pas-main.component.scss'
})
export class MaklumatPasMainComponent {
  //ReactiveModule Form
  pasForm!: FormGroup;
  ...
  goNext(): void {
    ...
    if (index !== -1 && index + 1 < this.steps.length) {
      ...
      this.router.navigate(['../sign-on-to-join-ship-main'],  {relativeTo: this.route});
    }
  }
