...
@Component({
  selector: 'app-keluar-kaunter-manual-kenderaan-profil',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './keluar-kaunter-manual-kenderaan-profil.component.html',
  styleUrl: './keluar-kaunter-manual-kenderaan-profil.component.scss'
})
export class KeluarKaunterManualKenderaanProfilComponent implements OnInit {
