...
@Component({
  selector: 'app-imbasan-dokumen-passport',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './imbasan-dokumen-passport.component.html',
  styleUrls: ['./imbasan-dokumen-passport.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class ImbasanDokumenPassportComponent {
  ...
  OnTutup(): void {
    this.router.navigate(['../maklumat-profil-pengembara-main'], { relativeTo: this.route });
  }
