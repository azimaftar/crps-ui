...
@Component({
  ...
  templateUrl: './cap-jari-main.component.html',
  styleUrls: ['./cap-jari-main.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapJariMainComponent {
...
onImbasanClick() {
  ...
  if (this.labelJari === 'Empat (4) Jari Kiri:') {
      ...
      this.router.navigate(['../cap-jari-both-main'], { relativeTo: this.route });
    } else {
