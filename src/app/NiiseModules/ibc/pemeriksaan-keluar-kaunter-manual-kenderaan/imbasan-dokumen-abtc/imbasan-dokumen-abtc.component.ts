...
@Component({
  selector: 'app-imbasan-dokumen-abtc',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './imbasan-dokumen-abtc.component.html',
  styleUrl: './imbasan-dokumen-abtc.component.scss',
})
export class ImbasanDokumenAbtcComponent {
