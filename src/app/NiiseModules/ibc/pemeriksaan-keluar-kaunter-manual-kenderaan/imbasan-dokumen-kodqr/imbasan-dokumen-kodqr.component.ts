...
@Component({
  selector: 'app-imbasan-dokumen-kodqr',
  imports: [
    FormsModule,
    CommonModule
  ],
  templateUrl: './imbasan-dokumen-kodqr.component.html',
  styleUrl: './imbasan-dokumen-kodqr.component.scss'
})
export class ImbasanDokumenKodqrComponent {
