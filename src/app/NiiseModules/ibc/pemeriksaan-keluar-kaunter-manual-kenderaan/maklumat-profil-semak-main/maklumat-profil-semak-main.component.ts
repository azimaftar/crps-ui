...
@Component({
  selector: 'app-maklumat-profil-semak-main',
  ...
  templateUrl: './maklumat-profil-semak-main.component.html',
  styleUrl: './maklumat-profil-semak-main.component.scss'
})
export class MaklumatProfilSemakMainComponent {
  //ReactiveModule Form
  ...
  steps = [
    ...
    { number: 2, title: 'Maklumat Visa', route: '/maklumat-visa' },
    { number: 3, title: 'Maklumat Pas/Permit', route: '/maklumat-pas' },
    { number: 4, title: 'Maklumat Pengguna Kerap (FTF)', route: '/maklumat-pengguna-kerap' },
    { number: 5, title: 'Sign On To Join Ship', route: '/sign-on-to-join-ship' },
  ];
  ...
  semakMaklumatPengembara() {
    ...
    console.log('isWarganegara:', this.isWarganegara);
         ...
         this.router.navigate(['../maklumat-profil-main'],  {relativeTo: this.route});
