...
export const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'semakan-status-e-gate-motosikal',
        loadComponent: () =>
          import('./semakan-status-e-gate-motosikal/semakan-status-e-gate-motosikal.component')
            .then((m) => m.SemakanStatusEGateMotosikalComponent)
      },
      {
