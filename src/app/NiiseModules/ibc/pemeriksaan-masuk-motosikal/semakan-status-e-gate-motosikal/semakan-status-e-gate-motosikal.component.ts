...
@Component({
  selector: 'app-semakan-status-e-gate-motosikal',
  imports: [
    CommonModule,
    FormsModule,
    CardModule,
  ...
  templateUrl: './semakan-status-e-gate-motosikal.component.html',
  styleUrl: './semakan-status-e-gate-motosikal.component.scss'
})
export class SemakanStatusEGateMotosikalComponent {
  // selectedGate = '';
  ...
  viewGateDetails(gate: any) {
    ...
    this.showModal = true; //bukak modal
  }
