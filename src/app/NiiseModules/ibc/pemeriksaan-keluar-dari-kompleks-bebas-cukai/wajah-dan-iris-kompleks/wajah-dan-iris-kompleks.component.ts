...
@Component({
  selector: 'app-wajah-dan-iris-kompleks',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './wajah-dan-iris-kompleks.component.html',
  styleUrls: ['./wajah-dan-iris-kompleks.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class WajahDanIrisKompleksComponent {
