...
@Component({
  selector: 'app-maklumat-cap-jari-kompleks',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './maklumat-cap-jari-kompleks.component.html',
  styleUrls: ['./maklumat-cap-jari-kompleks.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class MaklumatCapJariKompleksComponent {
...
onImbasanClick() {
  ...
  if (this.labelJari === 'Empat (4) Jari Kiri:') {
      ...
      this.router.navigate(['../maklumat-cap-jari-both-kompleks'], { relativeTo: this.route });
    } else {
...
//   imports: [],
//   templateUrl: './maklumat-cap-jari-kompleks.component.html',
//   styleUrl: './maklumat-cap-jari-kompleks.component.scss'
// })
// export class MaklumatCapJariKompleksComponent {
