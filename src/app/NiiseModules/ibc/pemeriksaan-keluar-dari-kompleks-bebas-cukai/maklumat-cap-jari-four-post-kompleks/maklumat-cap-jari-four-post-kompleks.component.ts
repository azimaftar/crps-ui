...
@Component({
  selector: 'app-maklumat-cap-jari-four-post-kompleks',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './maklumat-cap-jari-four-post-kompleks.component.html',
  styleUrls: ['./maklumat-cap-jari-four-post-kompleks.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class MaklumatCapJariFourPostKompleksComponent {
  ...
  thumbLeftUrl = '';
  thumbRightUrl = '';
  nilaiWajahKiri: string = '0%'; // default
...
OnOKButtonClick(){
console.log('OKe button clicked');
  this.router.navigate(['../maklumat-profil-kompleks'], {
  ...
  closeModal(): void {
    ...
    // ✅ Redirect hanya kalau bukan nak buka biometric
...
//   imports: [],
//   templateUrl: './maklumat-cap-jari-four-post-kompleks.component.html',
//   styleUrl: './maklumat-cap-jari-four-post-kompleks.component.scss'
// })
// export class MaklumatCapJariFourPostKompleksComponent {
