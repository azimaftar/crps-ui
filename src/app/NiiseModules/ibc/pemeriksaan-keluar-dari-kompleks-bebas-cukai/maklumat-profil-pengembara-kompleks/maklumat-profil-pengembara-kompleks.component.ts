...
@Component({
  selector: 'app-maklumat-profil-pengembara-kompleks',
    standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './maklumat-profil-pengembara-kompleks.component.html',
  styleUrl: './maklumat-profil-pengembara-kompleks.component.scss'
})
export class MaklumatProfilPengembaraKompleksComponent implements OnInit {
