...
export class BiometrikCapjariComponent {
  ...
  openCapJariBoth() {
    this.router.navigate(['ibc/pemeriksaan-masuk-kbc/biometrik-ibujari'])
  }
  openWajahIris() {
    this.router.navigate(['ibc/pemeriksaan-masuk-kbc/biometrik-wajah'], { queryParams: { statusImbas: "imbas" } })
  }
}
