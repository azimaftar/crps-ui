...
@Component({
  selector: 'app-maklumat-profil-pegawai-agensi-perkapalan',
  standalone: true,
  ...
  templateUrl: './maklumat-profil-pegawai-agensi-perkapalan.component.html',
  styleUrl: './maklumat-profil-pegawai-agensi-perkapalan.component.scss'
})

export class MaklumatProfilPegawaiAgensiPerkapalanComponent implements OnInit {

  // Form data model
    formData: FormData = {
      agencyOfficerName: 'Warganegara',
      repCategory: 'Endoser',
