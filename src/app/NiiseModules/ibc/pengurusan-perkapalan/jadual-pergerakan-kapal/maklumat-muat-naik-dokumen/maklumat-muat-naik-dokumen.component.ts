...
@Component({
  selector: 'app-maklumat-muat-naik-dokumen',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-muat-naik-dokumen.component.html',
  styleUrl: './maklumat-muat-naik-dokumen.component.scss'
})
export class MaklumatMuatNaikDokumenComponent {
...
// Ship list for table
  ...
  this.currentStep = matched ? matched.number : 9;
 ...
 entryTime: ['']
  ...
  goBack(): void {
  this.router.navigate(['../maklumat-pergerakan-kapal'], { relativeTo: this.route });
  }
