...
export class MaklumatPergerakanKapalComponent {
...
// Ship list for table
 ...
 namaAnakKapal: ['', Validators.required],
 hubunganAnakKapal: [''],
 tarikhTamat2: [''],
 jenisdokperjalanan: [''],
 nodokumenperjalanan: [''],
...
// ADD THESE NEW PROPERTIES FOR FILE UPLOAD:
  ...
  onSimpanClicked(): void {
  if (this.profilForm.invalid) {
    this.markFormGroupTouched(); // Mark all controls to show validation error states
    this.modalTitle = 'Sila lengkapkan semua maklumat yang diperlukan.';
    this.showModal = true;
    this.showModalAlert = true;
    return;
  }
  ...
  console.log('Form is valid. Simpan clicked.');

  this.onSubmit(); // or any save logic
}
