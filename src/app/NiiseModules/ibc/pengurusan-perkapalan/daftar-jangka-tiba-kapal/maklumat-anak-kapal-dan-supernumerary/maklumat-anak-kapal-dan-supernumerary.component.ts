...
@Component({
  selector: 'app-maklumat-anak-kapal-dan-supernumerary',
  standalone: true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-anak-kapal-dan-supernumerary.component.html',
  styleUrl: './maklumat-anak-kapal-dan-supernumerary.component.scss'
})
export class MaklumatAnakKapalDanSupernumeraryComponent implements OnInit{
...
// Form data model
  ...
  shipList: ShipData[] = [];
    ...
    goToPrevious(): void {
      ...
      this.router.navigate(['/ibc/pengurusan-perkapalan/maklumat-jangka-tiba-kapal']);
    }
    ...
    validateForm(): void {
      const requiredFields = [
        ...
        this.formData.TarikhTamatBukuPelaut,
