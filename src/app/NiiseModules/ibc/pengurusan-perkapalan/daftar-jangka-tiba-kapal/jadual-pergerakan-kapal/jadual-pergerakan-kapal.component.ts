...
@Component({
  selector: 'app-jadual-pergerakan-kapal',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './jadual-pergerakan-kapal.component.html',
  styleUrl: './jadual-pergerakan-kapal.component.scss'
})
export class JadualPergerakanKapalComponent {
