...
@Component({
  selector: 'app-maklumat-penumpang-rawatan-hospital',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-penumpang-rawatan-hospital.component.html',
  styleUrl: './maklumat-penumpang-rawatan-hospital.component.scss'
})
export class MaklumatPenumpangRawatanHospitalComponent {
...
// Form data model
    ...
    shipList: ShipData[] = [];
      ...
      goToNext(): void {
        ...
        // Add your navigation logic here
        this.router.navigate(['/ibc/pengurusan-perkapalan/maklumat-pergerakan-kapal']);
      }
