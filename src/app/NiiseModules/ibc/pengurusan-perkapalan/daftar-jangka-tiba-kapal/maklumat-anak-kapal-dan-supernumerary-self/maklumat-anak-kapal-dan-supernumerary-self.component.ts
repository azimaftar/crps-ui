...
@Component({
  selector: 'app-maklumat-anak-kapal-dan-supernumerary-self',
  standalone: true,
  ...
  templateUrl: './maklumat-anak-kapal-dan-supernumerary-self.component.html',
  styleUrl: './maklumat-anak-kapal-dan-supernumerary-self.component.scss'
})
export class MaklumatAnakKapalDanSupernumerarySelfComponent {
