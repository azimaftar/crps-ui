...
@Component({
  selector: 'app-maklumat-pergerakan-kapal',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-pergerakan-kapal.component.html',
  styleUrl: './maklumat-pergerakan-kapal.component.scss'
})
export class MaklumatPergerakanKapalComponent implements OnInit{
