...
@Component({
  selector: 'app-pengesahan-data-pengembara',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './pengesahan-data-pengembara.component.html',
  styleUrl: './pengesahan-data-pengembara.component.scss'
})
export class PengesahanDataPengembaraComponent {
