...
@Component({
  selector: 'app-maklumat-orang-yang-diselamatkan-self',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-orang-yang-diselamatkan-self.component.html',
  styleUrl: './maklumat-orang-yang-diselamatkan-self.component.scss'
})
export class MaklumatOrangYangDiselamatkanSelfComponent {
