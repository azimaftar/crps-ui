...
interface FormData { 
  ...
  CallSign: string;
  VoyageNo: string;
  DestinasiPelabuhanTerakhir: string;
  PelabuhanSeterusnya: string;
  BilanganAnakKapal: string;
  BilanganPenumpang: string;
  NamaNakhoda: string;
  NamaSyarikatPerkapalan: string;
  JangkaTiba: string;
  JangkaRapatdanDermaga: string;
  JangkaBelayar: string;
  NoVoyage: string;
  Pelabuhan: string;
  TarikhdanMasaKetibaan: string;
  TarikhdanMasaPelepasan: string;
}
...
@Component({
  selector: 'app-maklumat-jangka-tiba-kapal',
  standalone:true,
  imports: [
      CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-jangka-tiba-kapal.component.html',
  styleUrl: './maklumat-jangka-tiba-kapal.component.scss'
})
export class MaklumatJangkaTibaKapalComponent implements OnInit{
...
// Form data model
    formData: FormData = { 
      ...
      CallSign: '',
      VoyageNo: '',
      DestinasiPelabuhanTerakhir: '',
      PelabuhanSeterusnya: '',
      BilanganAnakKapal: '',
      BilanganPenumpang: '',
      NamaNakhoda: '',
      NamaSyarikatPerkapalan: '',
      JangkaTiba: '',
      JangkaRapatdanDermaga: '',
      JangkaBelayar: '',
      NoVoyage: '',
      Pelabuhan: '',
      TarikhdanMasaKetibaan: '',
      TarikhdanMasaPelepasan: '',
    };
  // Ship list for table
  shipList: ShipData[] = [];
    // Validation flags
    ...
    goToPrevious(): void {
      ...
      this.router.navigate(['/ibc/permohonan-pendaftaran-ejen-perkapalan/laman-utama-permohonan-pendaftaran-ejen']);
    }
    ...
    validateForm(): void {
      const requiredFields = [
        ...
        this.formData.DestinasiPelabuhanTerakhir,
        this.formData.PelabuhanSeterusnya,
        this.formData.BilanganAnakKapal,
        this.formData.BilanganPenumpang,
        this.formData.NamaNakhoda,
        this.formData.NamaSyarikatPerkapalan,
        this.formData.JangkaTiba,
        this.formData.JangkaRapatdanDermaga,
        this.formData.JangkaBelayar,
        this.formData.NoVoyage,
        this.formData.Pelabuhan,
        this.formData.TarikhdanMasaKetibaan,
        this.formData.TarikhdanMasaPelepasan,
      ];
