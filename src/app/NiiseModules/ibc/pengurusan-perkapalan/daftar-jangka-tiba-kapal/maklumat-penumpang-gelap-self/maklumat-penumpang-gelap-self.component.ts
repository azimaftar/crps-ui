...
@Component({
  selector: 'app-maklumat-penumpang-gelap-self',
  standalone: true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-penumpang-gelap-self.component.html',
  styleUrl: './maklumat-penumpang-gelap-self.component.scss'
})
export class MaklumatPenumpangGelapSelfComponent {
