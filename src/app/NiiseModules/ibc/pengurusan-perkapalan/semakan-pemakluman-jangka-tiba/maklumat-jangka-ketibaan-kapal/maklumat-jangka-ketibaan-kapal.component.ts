...
@Component({
  selector: 'app-maklumat-jangka-ketibaan-kapal',
  standalone:true,
  imports: [
    CommonModule,
      ReactiveFormsModule,
  ...
  templateUrl: './maklumat-jangka-ketibaan-kapal.component.html',
  styleUrl: './maklumat-jangka-ketibaan-kapal.component.scss'
})
export class MaklumatJangkaKetibaanKapalComponent {
