...
@Component({
  selector: 'app-laman-utama-semakan',
  standalone:true,
  imports: [
    CommonModule,
        FormsModule,
  ...
  templateUrl: './laman-utama-semakan.component.html',
  styleUrl: './laman-utama-semakan.component.scss'
})
export class LamanUtamaSemakanComponent {
