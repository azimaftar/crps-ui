...
@Component({
  selector: 'app-paparan-pas-menaiki-kapal-bahagian-hadapan',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  templateUrl: './paparan-pas-menaiki-kapal-bahagian-hadapan.component.html',
  styleUrl: './paparan-pas-menaiki-kapal-bahagian-hadapan.component.scss'
})
export class PaparanPasMenaikiKapalBahagianHadapanComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate([
      '/ibc/pengurusan-perkapalan/jana-kad-pas-menaiki-kapal/paparan-pas-menaiki-kapal-bahagian-hadapan'
    ]);
  }
