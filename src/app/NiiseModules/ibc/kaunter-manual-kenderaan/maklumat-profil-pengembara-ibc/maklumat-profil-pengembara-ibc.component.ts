...
@Component({
  selector: 'app-maklumat-profil-pengembara-ibc',
  ...
  templateUrl: './maklumat-profil-pengembara-ibc.component.html',
  styleUrl: './maklumat-profil-pengembara-ibc.component.scss'
})
export class MaklumatProfilPengembaraIbcComponent {
  //ReactiveModule Form
