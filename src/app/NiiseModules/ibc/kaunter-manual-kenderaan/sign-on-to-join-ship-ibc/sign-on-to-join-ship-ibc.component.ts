...
@Component({
  selector: 'app-sign-on-to-join-ship-ibc',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    RouterModule,
  ...
  templateUrl: './sign-on-to-join-ship-ibc.component.html',
  styleUrl: './sign-on-to-join-ship-ibc.component.scss'
})

export class SignOnToJoinShipIbcComponent implements OnInit {
  //ReactiveModule Form
  visaForm!: FormGroup;
