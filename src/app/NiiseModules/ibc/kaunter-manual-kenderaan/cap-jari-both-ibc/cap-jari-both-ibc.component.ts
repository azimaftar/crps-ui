...
@Component({
  selector: 'app-cap-jari-both-ibc',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './cap-jari-both-ibc.component.html',
  styleUrls: ['./cap-jari-both-ibc.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapJariBothIbcComponent {
...
OnOKButtonClick() {
  ...
  this.router.navigate(['../cap-jari-four-post-ibc'], {
...
//   imports: [],
//   templateUrl: './cap-jari-both-ibc.component.html',
//   styleUrl: './cap-jari-both-ibc.component.scss'
// })
// export class CapJariBothIbcComponent {
