...
@Component({
  ...
  templateUrl: './cap-jari-four-post-ibc.component.html',
  styleUrls: ['./cap-jari-four-post-ibc.component.scss'],
})
export class CapJariFourPostIbcComponent implements OnInit {
