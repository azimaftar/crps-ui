  ...
  @Component({
    selector: 'app-imbasan-dokumen-lainlain',
  ...
  templateUrl: './imbasan-dokumen-lainlain.component.html',
  styleUrl: './imbasan-dokumen-lainlain.component.scss',
})
export class ImbasanDokumenLainlainComponent {
    //ReactiveModule Form
