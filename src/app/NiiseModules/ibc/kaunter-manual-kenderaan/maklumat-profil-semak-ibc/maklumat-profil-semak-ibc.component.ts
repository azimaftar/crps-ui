...
@Component({
  selector: 'app-maklumat-profil-semak-ibc',
  ...
  templateUrl: './maklumat-profil-semak-ibc.component.html',
  styleUrl: './maklumat-profil-semak-ibc.component.scss'
})
export class MaklumatProfilSemakIbcComponent {
  //ReactiveModule Form
