...
// @Component({
//   selector: 'app-maklumat-visa-sabah-sarawak',
//   imports: [],
//   templateUrl: './maklumat-visa-sabah-sarawak.component.html',
//   styleUrl: './maklumat-visa-sabah-sarawak.component.scss'
// })
// export class MaklumatVisaSabahSarawakComponent {
...
export class MaklumatVisaSabahSarawakComponent implements OnInit {
  visaForm!: FormGroup;
  ...
  goNext(): void {
    ...
    if (index !== -1 && index + 1 < this.steps.length) {
      this.router.navigate(['../maklumat-pas-sabah-sarawak'], { relativeTo: this.route });
    }
  }
