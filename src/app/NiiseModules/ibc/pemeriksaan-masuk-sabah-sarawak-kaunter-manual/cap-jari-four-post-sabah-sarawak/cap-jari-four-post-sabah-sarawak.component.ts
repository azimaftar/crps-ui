...
@Component({
  selector: 'app-cap-jari-four-post-sabah-sarawak',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './cap-jari-four-post-sabah-sarawak.component.html',
  styleUrls: ['./cap-jari-four-post-sabah-sarawak.component.scss'],
})
export class CapJariFourPostSabahSarawakComponent implements OnInit {
  ...
  OnOKButtonClick() {
    ...
    this.router.navigate(['../maklumat-profil-pengembara-sabah-sarawak'], {
