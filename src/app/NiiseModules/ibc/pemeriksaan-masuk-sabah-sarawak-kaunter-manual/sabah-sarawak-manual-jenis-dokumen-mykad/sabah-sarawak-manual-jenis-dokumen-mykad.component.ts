...
@Component({
  selector: 'app-sabah-sarawak-manual-jenis-dokumen-mykad',
  standalone: true,
  templateUrl: './sabah-sarawak-manual-jenis-dokumen-mykad.component.html',
  styleUrl: './sabah-sarawak-manual-jenis-dokumen-mykad.component.scss',
  imports: [
    CommonModule,
    FormsModule,
    RouterModule,
...
export class SabahSarawakManualJenisDokumenMykadComponent {
