...
@Component({
  selector: 'app-cap-jari-both-sabah-sarawak',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './cap-jari-both-sabah-sarawak.component.html',
  styleUrls: ['./cap-jari-both-sabah-sarawak.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapJariBothSabahSarawakComponent {
...
OnOKButtonClick() {
  ...
  this.router.navigate(['../cap-jari-four-post-sabah-sarawak'], {
