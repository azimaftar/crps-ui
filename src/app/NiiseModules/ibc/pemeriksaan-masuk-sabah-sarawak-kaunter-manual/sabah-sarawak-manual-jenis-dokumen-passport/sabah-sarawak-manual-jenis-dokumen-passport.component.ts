...
@Component({
  selector: 'app-sabah-sarawak-manual-jenis-dokumen-passport',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './sabah-sarawak-manual-jenis-dokumen-passport.component.html',
  styleUrl: './sabah-sarawak-manual-jenis-dokumen-passport.component.scss'
})
export class SabahSarawakManualJenisDokumenPassportComponent {
...
OnTutup(): void {
  this.router.navigate(['../maklumat-profil-sabah-sarawak'],
    { 
      relativeTo: this.route,
      queryParams: { docType: 'P - Passport' }
    }
  );
}
