...
@Component({
  selector: 'app-maklumat-profil-pengembara-sabah-sarawak',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './maklumat-profil-pengembara-sabah-sarawak.component.html',
  styleUrl: './maklumat-profil-pengembara-sabah-sarawak.component.scss'
})
export class MaklumatProfilPengembaraSabahSarawakComponent implements OnInit {
  ...
  captureFaceAndIris() {
    ...
    this.router.navigate(['../face-iris-sabah-sarawak'], { relativeTo: this.route });
  }
  ...
  captureFingerprint() {
    ...
    this.router.navigate(['../cap-jari-sabah-sarawak'], { relativeTo: this.route });
  }
