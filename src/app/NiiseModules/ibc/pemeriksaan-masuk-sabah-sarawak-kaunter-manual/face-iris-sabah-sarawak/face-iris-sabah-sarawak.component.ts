...
@Component({
  selector: 'app-face-iris-sabah-sarawak',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './face-iris-sabah-sarawak.component.html',
  styleUrls: ['./face-iris-sabah-sarawak.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class FaceIrisSabahSarawakComponent {
