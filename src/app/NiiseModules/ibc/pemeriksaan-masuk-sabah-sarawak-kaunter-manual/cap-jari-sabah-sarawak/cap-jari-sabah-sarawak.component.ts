...
@Component({
  selector: 'app-cap-jari-sabah-sarawak',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './cap-jari-sabah-sarawak.component.html',
  styleUrls: ['./cap-jari-sabah-sarawak.component.scss'], // typo: should be "styleUrls" not "styleUrl"
})
export class CapJariSabahSarawakComponent {
...
onImbasanClick() {
  ...
  if (this.labelJari === 'Empat (4) Jari Kiri:') {
      ...
      this.router.navigate(['../cap-jari-both-sabah-sarawak'], { relativeTo: this.route });
    } else {
