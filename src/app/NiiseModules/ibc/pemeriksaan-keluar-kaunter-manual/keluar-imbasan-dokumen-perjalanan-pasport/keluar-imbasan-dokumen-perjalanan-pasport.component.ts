...
@Component({
  selector: 'app-keluar-imbasan-dokumen-perjalanan-pasport',
  imports: [
    CommonModule, 
    FormsModule,
  ...
  templateUrl: './keluar-imbasan-dokumen-perjalanan-pasport.component.html',
  styleUrl: './keluar-imbasan-dokumen-perjalanan-pasport.component.scss'
})
export class KeluarImbasanDokumenPerjalananPasportComponent {
  ...
  responseCode: string = ''; 
  // responseCode: string = 'IBC-S019'; // Test passport validity period < 6 months
  // responseCode: string = 'IBC-S018'; // Test passport expired
  ...
  async simulateValidation(): Promise<string> {
    ...
    // return 'IBC-S019'; // Test passport validity < 6 months
    // return 'IBC-S018'; // Test passport expired
    
    // SIMULATION: Check passport expiry date
    ...
    if (monthsDiff < 0) {
      return 'IBC-S018'; // Passport expired
    } else if (monthsDiff < 6) {
      return 'IBC-S019'; // Passport validity < 6 months
    }
  ...
  // Close form with validation (following senior dev pattern)
