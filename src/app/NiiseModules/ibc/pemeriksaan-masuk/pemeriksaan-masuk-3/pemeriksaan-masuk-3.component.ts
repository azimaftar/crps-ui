...
import { RujukPenyeliaComponent } from '../shared-modal/rujuk-penyelia/rujuk-penyelia.component';
import {
  ButtonDirective,
  ColComponent,
  DropdownComponent,
...
@Component({
  selector: 'app-pemeriksaan-masuk-3',
  standalone: true,
  imports: [
    RowComponent,
    ColComponent,
  ...
  templateUrl: './pemeriksaan-masuk-3.component.html',
  styleUrl: './pemeriksaan-masuk-3.component.scss'
})
export class PemeriksaanMasuk3Component {
  // Widgets config
