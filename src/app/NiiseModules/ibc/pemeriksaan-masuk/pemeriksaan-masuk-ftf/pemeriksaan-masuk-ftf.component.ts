...
@Component({
  selector: 'app-pemeriksaan-masuk-ftf',
  standalone:true,
  imports: [
    CardComponent,
    CardBodyComponent,
  ...
  templateUrl: './pemeriksaan-masuk-ftf.component.html',
  styleUrl: './pemeriksaan-masuk-ftf.component.scss'
})
export class PemeriksaanMasukFtfComponent {
// Step navigation
  currentStep = 4;
  ...
  goToNext(): void {
    this.router.navigate(['ibc/pemeriksaan-masuk/pemeriksaan-masuk-joinship']);
  }
