...
@Component({
  selector: 'app-pemeriksaan-masuk-joinship',
  imports: [
    CardComponent,
    CardBodyComponent,
    RowComponent,
  ...
  templateUrl: './pemeriksaan-masuk-joinship.component.html',
  styleUrl: './pemeriksaan-masuk-joinship.component.scss'
})
export class PemeriksaanMasukJoinshipComponent {
  // Step navigation
  currentStep = 5;
  ...
  constructor(private fb: FormBuilder,
    ...
    this.maklumatPengembaraForm = this.fb.group({
      ...
      shipName: [{ value: '', disabled: true }], //
      shipType: [{ value: '', disabled: true }],//
      noIMO: [{ value: '', disabled: true }], //
      callSign: [{ value: '', disabled: true }], //
      voyageNo: [{ value: '', disabled: true }], //
      companyName: [{ value: '', disabled: true }], //
      expArrDate: [{ value: '', disabled: true }],//
      expDepDate: [{ value: '', disabled: true }], //
      nextPort: [{ value: '', disabled: true }],
