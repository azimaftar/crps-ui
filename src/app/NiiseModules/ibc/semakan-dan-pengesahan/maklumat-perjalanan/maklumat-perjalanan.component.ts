...
@Component({
  selector: 'app-maklumat-perjalanan',
  imports: [
    CommonModule,
    ButtonModule,
    CardModule,
  ...
  templateUrl: './maklumat-perjalanan.component.html',
  styleUrl: './maklumat-perjalanan.component.scss'
})
export class MaklumatPerjalananComponent {
    // Form data model
    formData: FormData = {
