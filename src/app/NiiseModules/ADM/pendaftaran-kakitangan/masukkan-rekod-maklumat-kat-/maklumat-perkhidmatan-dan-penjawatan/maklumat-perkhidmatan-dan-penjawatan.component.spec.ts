...
import { MaklumatPerkhidmatanDanPerjawatanComponent } from './maklumat-perkhidmatan-dan-penjawatan.component';

describe('MaklumatPerkhidmatanDanPenjawatanComponent', () => {
