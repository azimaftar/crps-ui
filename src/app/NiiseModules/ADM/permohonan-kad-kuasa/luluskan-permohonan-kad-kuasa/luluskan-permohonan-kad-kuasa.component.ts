...
@Component({
  selector: 'app-luluskan-permohonan-kad-kuasa',
  imports: [
    CommonModule,
    CardModule,
    GridModule,
  ...
  templateUrl: './luluskan-permohonan-kad-kuasa.component.html',
  styleUrl: './luluskan-permohonan-kad-kuasa.component.scss'
})
export class LuluskanPermohonanKadKuasaComponent {
 ...
 // Current active step tracking
  ...
  mainSteps = [
    ...
    { mainStep: 5, mainLabel: 'Luluskan Permohonan Kad Kuasa' },
  ];
