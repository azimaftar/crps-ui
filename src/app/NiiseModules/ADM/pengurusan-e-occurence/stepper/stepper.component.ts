...
export class StepperComponent implements OnInit {
  ...
  // Main steps only
  mainSteps = [
    { mainStep: 1, mainLabel: 'Daftar Laporan Kejadian' },
    { mainStep: 2, mainLabel: 'Pengesahan Laporan Kejadian' },
    { mainStep: 3, mainLabel: 'Kelulusan Laporan Kejadian' },
    { mainStep: 4, mainLabel: 'Penilaian Laporan Kejadian' }
  ];
