...
@Component({
  selector: 'app-penilaian-laporan-kejadian',
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  templateUrl: './penilaian-laporan-kejadian.component.html',
  styleUrl: './penilaian-laporan-kejadian.component.scss'
})
export class PenilaianLaporanKejadianComponent {
  ...
  navigateNextPage() {
    this.router.navigate(['/adm/pengurusan-e-occurence/buat-penilaian-kemas-kini-tahap-kejadian/penilaian-laporan-kejadian/penilaian']);
  }
