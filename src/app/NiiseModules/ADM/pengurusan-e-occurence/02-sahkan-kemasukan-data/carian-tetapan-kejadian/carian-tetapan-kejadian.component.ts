...
@Component({
  selector: 'app-carian-tetapan-kejadian',
  imports: [
    CommonModule,
    CardModule,
    GridModule,
  ...
  templateUrl: './carian-tetapan-kejadian.component.html',
  styleUrl: './carian-tetapan-kejadian.component.scss'
})
export class CarianTetapanKejadianComponent {
