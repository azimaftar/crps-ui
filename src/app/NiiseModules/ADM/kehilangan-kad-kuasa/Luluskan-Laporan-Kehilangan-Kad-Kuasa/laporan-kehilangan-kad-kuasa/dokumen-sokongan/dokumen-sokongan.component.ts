...
export class DokumenSokonganComponent {
  ...
  navigatePreviousPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-5/maklumat-laporan',
    ]);
  }

    semakLaporan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-5/semak-laporan',
    ]);
  }

  navigateNextPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-5/sahkan-laporan/sahkan-laporan-kehilangan',
    ]);
  }
