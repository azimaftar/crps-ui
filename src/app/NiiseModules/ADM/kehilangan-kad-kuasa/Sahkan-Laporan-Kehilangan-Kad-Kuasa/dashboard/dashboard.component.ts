...
export class DashboardComponent implements OnInit {
  ...
  navigateToPengesahanLaporanSiasatan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/sahkan-laporan/sahkan-laporan-siasatan',
    ]);
  }

  navigateToKelulusanLaporanSiasatan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-5/luluskan-laporan/luluskan-laporan-kehilangan',
    ]);
  }
