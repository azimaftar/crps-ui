...
export class DokumenSokonganComponent {
  ...
  navigatePreviousPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-2/maklumat-laporan',
    ]);
  }

    semakLaporan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-2/semak-laporan',
    ]);
  }

  navigateNextPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-2/sahkan-laporan/sahkan-laporan-kehilangan',
    ]);
  }
