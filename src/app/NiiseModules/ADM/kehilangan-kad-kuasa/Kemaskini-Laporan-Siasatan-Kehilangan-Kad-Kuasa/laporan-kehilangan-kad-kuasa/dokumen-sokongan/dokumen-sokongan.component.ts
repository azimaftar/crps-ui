...
export class DokumenSokonganComponent {
  ...
  navigatePreviousPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-3/maklumat-laporan',
    ]);
  }

    semakLaporan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-3/semak-laporan',
    ]);
  }

  navigateNextPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-3/sahkan-laporan/sahkan-laporan-kehilangan',
    ]);
  }
