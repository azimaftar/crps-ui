...
export class LaporanSiasatanComponent {
  ...
  navigatePreviousPage() {
    this.router.navigate(['adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/sahkan-laporan/sahkan-laporan-kehilangan']);
  }

  navigateNextPage() {
    this.router.navigate(['adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/sahkan-laporan/sahkan-laporan-siasatan']);
  }
}
