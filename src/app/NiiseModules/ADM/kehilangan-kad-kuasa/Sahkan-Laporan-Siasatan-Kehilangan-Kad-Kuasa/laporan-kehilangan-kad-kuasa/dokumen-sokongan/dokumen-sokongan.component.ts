...
export class DokumenSokonganComponent {
  ...
  navigatePreviousPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/maklumat-laporan',
    ]);
  }

    semakLaporan() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/semak-laporan',
    ]);
  }

  navigateNextPage() {
    this.router.navigate([
      'adm/kehilangan-kad-kuasa/laporan-kehilangan-kad-kuasa-4/sahkan-laporan/sahkan-laporan-kehilangan',
    ]);
  }
