...
@Component({
  selector: 'app-sahkan-laporan-pemulangan-perampasan-kad-kuasa',
  imports: [
    CommonModule,
    CardModule,
    GridModule,
  ...
  templateUrl: './sahkan-laporan-pemulangan-perampasan-kad-kuasa.component.html',
  styleUrl: './sahkan-laporan-pemulangan-perampasan-kad-kuasa.component.scss'
})
export class SahkanLaporanPemulanganPerampasanKadKuasaComponent {
