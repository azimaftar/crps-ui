...
@Component({
  selector: 'app-kemas-kini-status-terima-kad-kuasa',
  templateUrl: './kemas-kini-status-terima-kad-kuasa.component.html',
  styleUrl: './kemas-kini-status-terima-kad-kuasa.component.scss',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
...
export class KemasKiniStatusTerimaKadKuasaComponent {
