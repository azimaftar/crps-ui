...
@Component({
  selector: 'app-batal-penggantungan-kad-kuasa',
  templateUrl: './batal-penggantungan-kad-kuasa.component.html',
  styleUrl: './batal-penggantungan-kad-kuasa.component.scss',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
...
export class BatalPenggantunganKadKuasaComponent {
