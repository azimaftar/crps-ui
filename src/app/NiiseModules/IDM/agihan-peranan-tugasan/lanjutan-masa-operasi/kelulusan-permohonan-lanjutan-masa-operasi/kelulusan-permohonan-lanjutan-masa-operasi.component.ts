...
@Component({
  selector: 'kelulusan-permohonan-lanjutan-masa-operasi',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './kelulusan-permohonan-lanjutan-masa-operasi.component.html',
  styleUrls: ['./kelulusan-permohonan-lanjutan-masa-operasi.component.scss']
})
export class KelulusanPermohonanLanjutanMasaOperasiComponent implements OnInit {
