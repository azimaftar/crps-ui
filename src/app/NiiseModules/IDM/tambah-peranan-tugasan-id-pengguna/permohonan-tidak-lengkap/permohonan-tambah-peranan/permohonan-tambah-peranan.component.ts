...
export class PermohonanTambahPerananComponent implements OnInit {
  ...
  formData = {
    ...
    keputusan: 'Pemulangan Semula',
    pemulanganSemula: 'Hanif bin Rahman',
    tarikhPemulangan: '21 September 2022',
    catatanKeputusan: 'Muat Naik Dokumen Sokongan',
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/pemulangan-tambah-peranan-tugasan/maklumat-penetapan-peranan']);
  }
  ...
  goToNext(): void {
    ...
    // Add your navigation logic here
    this.router.navigate(['/IDM/pemulangan-tambah-peranan-tugasan/maklumat-profil-pegawai']);
  }
  ...
  submitRequest(): void {
    ...
    if (confirm('Adakah anda pasti untuk menghantar permohonan ini?')) {
      ...
      const submissionData = {
        maklumatKeputusan: {
          keputusan: this.formData.keputusan,
          pemulanganSemula: this.formData.pemulanganSemula,
          tarikhPemulangan: this.formData.tarikhPemulangan,
          catatanKeputusan: this.formData.catatanKeputusan
        },
        formData: {
  ...
  updateKeputusan(keputusan: string): void {
    this.formData.keputusan = keputusan;
  }

  updatePemulanganSemula(pemulanganSemula: string): void {
    this.formData.pemulanganSemula = pemulanganSemula;
  }
  ...
  updateCatatanKeputusan(catatan: string): void {
    this.formData.catatanKeputusan = catatan;
  }
}