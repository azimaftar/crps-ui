...
export class MaklumatProfilPegawaiComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/tambah-peranan-tugasan-id-pengguna/pengesahan-tambah-peranan-tugasan/permohonan-tambah-peranan']);
  }
  ...
  goToNext(): void {
    ...
    // Add your navigation logic here
    this.router.navigate(['/IDM/tambah-peranan-tugasan-id-pengguna/pengesahan-tambah-peranan-tugasan/maklumat-penetapan-peranan']);
  }
