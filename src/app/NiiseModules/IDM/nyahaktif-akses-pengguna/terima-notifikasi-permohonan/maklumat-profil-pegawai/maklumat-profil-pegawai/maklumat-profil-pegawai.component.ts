...
import { PermohonanNyahaktifComponent } from 'src/app/NiiseModules/IDM/nyahaktif-akses-pengguna/terima-notifikasi-permohonan/permohonan-nyahaktif/permohonan-nyahaktif.component';
import { TerimaNotifikasiComponent} from 'src/app/NiiseModules/IDM/nyahaktif-akses-pengguna/terima-notifikasi-permohonan/terima-notifikasi/terima-notifikasi/terima-notifikasi.component';
...
@Component({
  ...
  imports: [CommonModule,
    ...
    BadgeModule,
    GridModule,
    PermohonanNyahaktifComponent,
    TerimaNotifikasiComponent,
    ModalModule,
...
export class MaklumatProfilPegawaiComponent implements OnInit {
  permohonanPadamRekodBerjaya = false;
  permohonanPadamRekod = false;
  permohonanNyahVisible = false;
  stage: 'permohonan' | 'nextPage' = 'permohonan';

  goNext() {
    this.stage = 'nextPage';
  }
  closeModal() {
    this.permohonanNyahVisible = false;
  }
  showPermohonanNyahaktif() {
    this.permohonanNyahVisible = true;
  }
  openPermohonanPadamRekod() {
    this.permohonanPadamRekod = true;
  }
  closePermohonanPadamRekod() {
    this.permohonanPadamRekod = false;
  }
  openPermohonanPadamRekodBerjaya() {
    this.permohonanPadamRekod = false;
    this.permohonanPadamRekodBerjaya = true;
  }
  closePermohonanPadamRekodBerjaya() {
    this.permohonanPadamRekodBerjaya = false;
  }
