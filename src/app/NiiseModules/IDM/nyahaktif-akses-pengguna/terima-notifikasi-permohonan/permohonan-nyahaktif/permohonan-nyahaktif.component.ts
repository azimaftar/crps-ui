...
@Component({
  selector: 'app-permohonan-nyahaktif',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  templateUrl: './permohonan-nyahaktif.component.html',
  styleUrls: ['./permohonan-nyahaktif.component.scss']
})
export class PermohonanNyahaktifComponent implements OnInit {
