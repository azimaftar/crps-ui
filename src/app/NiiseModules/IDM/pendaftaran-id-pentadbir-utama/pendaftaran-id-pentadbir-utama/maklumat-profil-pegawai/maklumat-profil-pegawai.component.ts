...
export class MaklumatProfilPegawaiComponent implements OnInit {
  ...
  // Face scan modal properties
  isFaceScanModalOpen: boolean = false;
  ...
  goToNext(): void {
    ...
    // Add your navigation logic here
    this.router.navigate(['/IDM/pendaftaran-id-pentadbir-utama/pendaftaran-id-pentadbir-utama/maklumat-penetapan-peranan']);
  }
  ...
  // Face scan modal functions
  /**
   * Open face scan modal
   */
  openFaceScanModal(): void {
    this.isFaceScanModalOpen = true;
  }
  ...
  closeFaceScanModal(): void {
    this.isFaceScanModalOpen = false;
