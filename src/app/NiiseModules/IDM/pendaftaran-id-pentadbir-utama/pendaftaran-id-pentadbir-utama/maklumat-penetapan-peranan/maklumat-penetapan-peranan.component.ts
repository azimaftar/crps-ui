...
export class MaklumatPenetapanPerananComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/pendaftaran-id-pentadbir-utama/pendaftaran-id-pentadbir-utama/maklumat-profil-pegawai']);
  }

  goToNext(): void {
    // Navigation logic to previous step (not in template)
    console.log('Navigating to previous step');
    this.router.navigate(['/IDM/pendaftaran-id-pentadbir-utama/pendaftaran-id-pentadbir-utama/dokumen-sokongan']);
