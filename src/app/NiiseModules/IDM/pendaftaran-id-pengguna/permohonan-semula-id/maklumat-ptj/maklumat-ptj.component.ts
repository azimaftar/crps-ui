...
export class MaklumatPtjSelepasDataDihapusComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    console.log('Navigating to previous step');
     this.router.navigate(['/IDM/pendaftaran-id-pengguna/permohonan-semula-id/maklumat-penetapan-peranan']);
  }

  gotoNotifikasi(): void {
    console.log('Going to notifkasi');
     this.router.navigate(['/IDM/kakitangan-sedia-ada/terima-notifikasi-di-menu-notifikasi']);
  }
  ...
  goToNext(): void {
    ...
    this.router.navigate(['/IDM/pendaftaran-id-pengguna/permohonan-semula-id/dokumen-sokongan']);
