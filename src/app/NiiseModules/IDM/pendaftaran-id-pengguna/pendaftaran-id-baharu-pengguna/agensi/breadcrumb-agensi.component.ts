...
@Component({
  selector: 'app-breadcrumb-agensi',
  standalone: true,
      ...
      <div class="d-flex flex-column gap-3" style="position: relative;">
        ...
        >
          <div style="position: relative;">
            <div
              [class.bg-primary]="i + 1 === activeStep"
              [class.bg-secondary]="i + 1 !== activeStep"
          ...
          <div class="d-flex flex-column">
            ...
            <span
              [class.text-primary]="i + 1 === activeStep"
...
export class BreadcrumbAgensiComponent {
