...
export class MaklumatPenetapanPerananComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/pendaftaran-id-pengguna/kelulusan-permohonan-id/pendaftaran-id-pentadbir-utama/daftar-id-pengguna-kata-laluan/maklumat-profil-pegawai']);
  }
