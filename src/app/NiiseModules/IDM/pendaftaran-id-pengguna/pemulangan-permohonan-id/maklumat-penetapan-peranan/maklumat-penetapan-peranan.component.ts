...
export class MaklumatPenetapanPerananComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/pendaftaran-id-pengguna/pemulangan-permohonan-id/maklumat-profil-pegawai']);
  }

  goToNext(): void {
    // Navigation logic to next step (not in template)
    console.log('Navigating to next step');
    this.router.navigate(['/IDM/pendaftaran-id-pengguna/pemulangan-permohonan-id/maklumat-ptj']);
