...
export class MaklumatPtjSelepasDataDihapusComponent implements OnInit {
  ...
  goToPrevious(): void {
    console.log('Going to previous step - Dokumen Sokongan');
     this.router.navigate(['/IDM/pendaftaran-id-pengguna/pemulangan-permohonan-id/maklumat-penetapan-peranan']);
  }
  ...
  goToNext(): void {
    ...
    this.router.navigate(['/IDM/pendaftaran-id-pengguna/pemulangan-permohonan-id/dokumen-sokongan']);
  }
