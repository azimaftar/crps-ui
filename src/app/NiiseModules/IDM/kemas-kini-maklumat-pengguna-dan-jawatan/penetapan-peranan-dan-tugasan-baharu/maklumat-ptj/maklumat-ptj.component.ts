...
export class MaklumatPtjComponent implements OnInit {
  ...
  goToPrevious(): void {
    console.log('Going to previous step - Dokumen Sokongan');
     this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/penetapan-peranan-dan-tugasan-baharu/maklumat-penetapan-peranan']);
  }
  ...
  goToNext(): void {
    ...
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/penetapan-peranan-dan-tugasan-baharu/sejarah-id']);
  }
