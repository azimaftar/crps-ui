...
export class MaklumatPertukaranCawanganComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/penetapan-peranan-dan-tugasan-baharu/maklumat-pertukaran-cawangan']);
  }
  ...
  goToNext(): void {
    ...
    // Add your navigation logic here
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/penetapan-peranan-dan-tugasan-baharu/maklumat-profil-pegawai']);
  }
