...
@Component({
  ...
  styleUrls: ['./maklumat-ptj.component.scss']
})
export class MaklumatPtjComponent implements OnInit {
  ...
  ptjList: PTJItem[] = [
    { id: 1, kod: '040100', cawangan: 'PEJABAT IMIGRESEN KEDAH', selected: false }
  ];
  ...
  goToPrevious(): void {
    console.log('Going to previous step - Dokumen Sokongan');
     this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/terima-notifikasi-pertukaran-cawangan/maklumat-penetapan-peranan']);
  }
  ...
  goToNext(): void {
    ...
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/terima-notifikasi-pertukaran-cawangan/sejarah-id']);
  }
