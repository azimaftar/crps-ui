...
export class MaklumatProfilPegawaiComponent implements OnInit {
  ...
  goToPrevious(): void {
    ...
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/pengesahan-permohonan/maklumat-pertukaran-cawangan']);
  }
   ...
   */  goToNext(): void {
    ...
    // Add your navigation logic here
    this.router.navigate(['/IDM/kemas-kini-maklumat-pengguna-dan-jawatan/pengesahan-permohonan/maklumat-penetapan-peranan']);
  }
