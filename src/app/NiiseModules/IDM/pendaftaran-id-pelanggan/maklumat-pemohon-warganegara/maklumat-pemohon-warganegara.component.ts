...
@Component({
  ...
  templateUrl: './maklumat-pemohon-warganegara.component.html',
  styleUrls: ['./maklumat-pemohon-warganegara.component.scss']
})
export class MaklumatPemohonWarganegaraComponent implements OnInit {
