...
@Component({
    templateUrl: 'keputusan-permohonan-jkrim.html',
    styleUrls: [
    '../pengurusan-senarai-syak.component.scss'
  ],
  imports: [ButtonDirective, ReactiveFormsModule, CardComponent, CardBodyComponent
  ]
})
export class KeputusanPermohonanJkrim implements OnInit {
