...
import { BreadcrumbpemerhatianComponent } from './kelulusan-kes-pemerhatian/breadcrumb-pemerhatian.component';
...
@Component({
  selector: 'app-carian-kelulusan-kes',
  templateUrl: './carian-kelulusan-kes.component.html',
  styleUrls: [
...
export class CarianKelulusanKesComponent implements OnInit {
  ...
  Kelulusan(){
    this.router.navigate(['/sec/permehatian/carian-kelulusan-kes/kelulusan-kes-pemerhatian'])
  }
}