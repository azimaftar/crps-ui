...
@Component({
  selector: 'app-tambah-kes-pemerhatian-imigresen',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './tambah-kes-pemerhatian-imigresen.component.html',
  styleUrls: [
    '../../../permehatian.component.scss'
  ]
})  
export class TambahKesPemerhatianImigresenComponent {
  currentSection = 2;
