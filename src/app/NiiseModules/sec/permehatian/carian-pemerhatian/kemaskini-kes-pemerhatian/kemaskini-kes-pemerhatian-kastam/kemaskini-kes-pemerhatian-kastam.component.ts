...
@Component({
  selector: 'app-kemaskini-kes-pemerhatian-kastam',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './kemaskini-kes-pemerhatian-kastam.component.html',
  styleUrls: [
    '../../../permehatian.component.scss'
  ]
})
export class KemaskiniKesPemerhatianKastamComponent {
  currentSection = 2;
