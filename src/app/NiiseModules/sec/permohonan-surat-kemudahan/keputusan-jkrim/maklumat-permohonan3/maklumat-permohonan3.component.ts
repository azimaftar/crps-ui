...
@Component({
  selector: 'app-maklumat-permohonan3',
  imports: [
  CommonModule,
      ReactiveFormsModule,
      RouterModule,
  ...
  templateUrl: './maklumat-permohonan3.component.html',
  styleUrls: [
  '../../permohonan-surat-kemudahan.component.scss'
]

})
export class MaklumatPermohonan3Component implements OnInit {
  ...
  private redirectToFirstPageImmediate(): void {
    ...
    this.clearState();
    this.router.navigate(['/sec/permohonan-surat-kemudahan/jkrim']);
  } 
