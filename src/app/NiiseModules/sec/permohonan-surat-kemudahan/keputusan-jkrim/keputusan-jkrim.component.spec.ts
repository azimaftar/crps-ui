...
import { KeputusanJkrimComponent } from './keputusan-jkrim.component';

/**
 * STEP 1: Test suite setup
 * This file contains unit tests for the PermohonanBaruComponent
 */
describe('KeputusanJkrimComponent', () => {
  let component: KeputusanJkrimComponent;
  let fixture: ComponentFixture<KeputusanJkrimComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ KeputusanJkrimComponent ],
      imports: [ FormsModule ] // Required for ngModel binding
    })
    .compileComponents();

    fixture = TestBed.createComponent(KeputusanJkrimComponent);
