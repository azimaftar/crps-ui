...
@Component({
  selector: 'app-kelulusan-permohonan-page1',
...
export class KelulusanPermohonanComponent implements OnInit {
  ...
  steps = [
    ...
    { number: 2, title: 'Maklumat Permohonan', isAccessible: false, route: '/sec/pengurusan-pengendalian-pengesahan/pengesahan-pergerakan/kelulusan-permohonan/maklumat-permohonan' },
    { number: 3, title: 'Kelulusan Permohonan', isAccessible: false, route: '/sec/pengurusan-pengendalian-pengesahan/pengesahan-pergerakan/kelulusan-permohonan/kelulusan-permohonan' }
  ];
