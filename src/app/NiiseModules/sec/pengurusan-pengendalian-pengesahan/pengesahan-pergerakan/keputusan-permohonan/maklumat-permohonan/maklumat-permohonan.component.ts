...
@Component({
  selector: 'app-maklumat3-permohonan-semakan',
...
export class MaklumatPermohonanComponent implements OnInit {
  ...
  formData: any = null;
  ngOnInit(): void {
    this.formData =  this.permohonanFormDataService.getKeputusanPermohonan();
  ...
  navigateToStep(steps: number): void {
    this.permohonanFormDataService.setKeputusanPermohonan(this.formData);
