...
@Component({
  ...
  templateUrl: './pengesahan-passport.component.html',
  styleUrls: ['../menu-pertanyaan.component.scss']
})


export class PengesahanPassportComponent implements OnInit {
  private _selectedCategory: string = '';
  currentStep: number = 1; // default fallback
  identificationNumber: string = '';
  searchResults: Subject[] = [];
  noResultsFound: boolean = false;
  pageTitle = 'Senarai Permohonan Pengesahan Pasport';
  ...
  onSubmit(): void {
    ...
    this.subjectService.getGroupedSubjects().subscribe((groupedData) => {
      ...
      console.log("Input:", this.identificationNumber);
