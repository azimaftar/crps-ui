...
import { MenuPertanyaanComponent } from './menu-pertanyaan.component';

/**
 * STEP 1: Test suite setup
 * This file contains unit tests for the MenuPertanyaanComponent
 */
describe('MenuPertanyaanComponent', () => {
  let component: MenuPertanyaanComponent;
  let fixture: ComponentFixture<MenuPertanyaanComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ MenuPertanyaanComponent ],
      imports: [ FormsModule ] // Required for ngModel binding
    })
    .compileComponents();

    fixture = TestBed.createComponent(MenuPertanyaanComponent);
