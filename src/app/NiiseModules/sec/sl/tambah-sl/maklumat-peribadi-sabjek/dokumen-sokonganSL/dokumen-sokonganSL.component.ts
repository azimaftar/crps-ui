...
@Component({
  selector: 'app-dokumen-sokonganSL',
  imports: [
    CommonModule,
    FormsModule,
    CardComponent,
  ...
  templateUrl: './dokumen-sokonganSL.component.html',
  styleUrls: [
    '../../../sl.component.scss'
  ]
})
export class DokumenSokonganComponent implements OnInit {
  ...
  jenisPermohonan: number = 1; //1: Aktif , 0: Baru
  ...
  async submitForm(): Promise<void> {
    ...
    this.http.post(this.apiUrl+'/postMaklumatSL', finalJsonPayload).subscribe({
      next: (res) => {
