...
@Component({
  ...
  styleUrl: './pinda-sl.component.scss'
})
export class PindaSlComponent {
  ...
  currentStep = 2;
  steps = [
    { number: 2, title: 'Maklumat Peribadi Subjek', route: '/sec/selenggara-senarai-syak/pinda-sl' },
    { number: 3, title: 'Maklumat Tindakan', route: '/sec/selenggara-senarai-syak/pinda-sl/pinda-sl-maklumat-tindakan' },
    { number: 4, title: 'Dokumen Sokongan', route: '/sec/selenggara-senarai-syak/pinda-sl/pinda-sl-maklumat-tindakan/pinda-sl-dokumen-sokongan' },
  ];
  ...
  nextPage(): void {
    this.router.navigate(['./pinda-sl-maklumat-tindakan'], {
