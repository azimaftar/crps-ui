...
export class DokumenComponent {
  ...
  totalSteps: number = 3;
  steps = [
    { number: 1, title: 'Maklumat Peribadi Subjek', route: '/sec/pengurusan-senarai-syak/tambah-subjek/kemaskini-peribadi-subjek/' },
    { number: 2, title: 'Maklumat Tindakan', route: '/sec/pengurusan-senarai-syak/carian-subjek/tindakan' },
    { number: 3, title: 'Dokumen Sokongan', route: '/sec/pengurusan-senarai-syak/carian-subjek/dokumen' },
  ];
  
  goToPreviousSection() {
    // Navigate to maklumat-tindakan component
    this.router.navigate(['/sec/pengurusan-senarai-syak/carian-subjek/tindakan']);
  }
