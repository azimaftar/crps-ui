...
export class Dokumen2Component {
  ...
  totalSteps: number = 3;
  steps = [
    { number: 1, title: 'Maklumat Peribadi Subjek', route: '/sec/pengurusan-senarai-syak/batal' },
    { number: 2, title: 'Maklumat Tindakan', route: '/sec/pengurusan-senarai-syak/tindakan' },
    { number: 3, title: 'Dokumen Sokongan', route: '/sec/pengurusan-senarai-syak/dokumen2' },
  ];
  
  goToPreviousSection() {
    // Navigate to maklumat-tindakan component
    this.router.navigate(['/sec/pengurusan-senarai-syak/tindakan']);
  }
  ...
  closePastiModal(): void {
    ...
    this.router.navigate(['/sec/pengurusan-senarai-syak/carian-subjek']);
  }
}