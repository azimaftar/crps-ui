...
import { BreadcrumbkeputusanmohonComponent } from './papar-keputusan/breadcrumb-keputusan.component';
...
@Component({
  selector: 'app-keputusan-permohonan-bss-jkrim',
  templateUrl: './keputusan-permohonan-bss-jkrim.component.html',
  styleUrls: ['./keputusan-permohonan-bss-jkrim.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class KeputusanPermohonanbssJkrimComponent implements OnInit {
  ...
  Papar() {
    this.router.navigate(['/sec/bss/keputusan-permohonan-bss-jkrim/papar-keputusan']);
  }
