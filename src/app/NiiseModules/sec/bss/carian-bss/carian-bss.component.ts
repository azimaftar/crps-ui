...
@Component({
  selector: 'app-carian-bss',
  templateUrl: './carian-bss.component.html',
...
export class CarianbssComponent implements OnInit {
  ...
  Papar() {
    this.router.navigate(['/sec/bss/carian-bss/papar-bss']);
  }
