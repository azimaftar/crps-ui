...
@Component({
  selector: 'app-Kelulusan-Permohonan-bss',
  templateUrl: './Kelulusan-Permohonan-bss.component.html',
  styleUrls: ['./Kelulusan-Permohonan-bss.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class KelulusanPermohonanbssComponent implements OnInit {
  ...
  Papar() {
    this.router.navigate(['/sec/bss/Kelulusan-Permohonan-bss/papar-Kelulusan']);
  }
