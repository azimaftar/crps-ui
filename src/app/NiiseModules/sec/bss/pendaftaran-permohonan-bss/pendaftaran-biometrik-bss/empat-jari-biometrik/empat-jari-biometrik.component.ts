...
@Component({
  selector: 'app-empat-jari-biometrik',
  templateUrl: './empat-jari-biometrik.component.html',
  styleUrls: ['./empat-jari-biometrik.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
...
export class EmpatJariBiometrikComponent implements AfterViewInit {
