...
import { BiometrikModalComponent } from './biometrik-modal/biometrik-modal.component';


@Component({
  selector: 'app-pendaftaran-biometrik-bss',
  templateUrl: './pendaftaran-biometrik-bss.component.html',
  styleUrls: ['./pendaftaran-biometrik-bss.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
    ...
    ModalModule,
    FormsModule,
    BiometrikModalComponent
],
})
export class PendaftaranBiometrikBssComponent implements AfterViewInit {
...
onFingerprintCaptured(imageData: string) {
  ...
  empatjari() {
    this.router.navigate(['/sec/bss/pendaftaran-permohonan-bss/pendaftaran-biometrik-bss/empat-jari-biometrik']);
  }
    WajahIris() {
    this.router.navigate(['/sec/bss/pendaftaran-permohonan-bss/pendaftaran-biometrik-bss/wajah-iris-biometrik']);
  }
