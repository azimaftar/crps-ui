...
import { BreadcrumbsyormohonComponent } from './papar-syor/breadcrumb-syormohon.component';
...
@Component({
  selector: 'app-pengesyoran-permohonan-bss',
  templateUrl: './pengesyoran-permohonan-bss.component.html',
...
export class PengesyoranPermohonanbssComponent implements OnInit {
  ...
  Papar() {
    this.router.navigate(['/sec/bss/pengesyoran-permohonan-bss/papar-syor']);
  }
