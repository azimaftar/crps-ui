...
@Component({
  selector: 'app-carian-kelulusan-permohonan',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './carian-kelulusan-permohonan.component.html',
  styleUrls: ['./carian-kelulusan-permohonan.component.scss'],
})
export class CarianKelulusanPermohonanComponent {
