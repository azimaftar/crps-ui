...
@Component({
  selector: 'app-keputusan-kelulusan-permohonan',
  imports: [CommonModule, FormsModule],
  templateUrl: './keputusan-kelulusan-permohonan.component.html',
  styleUrl: './keputusan-kelulusan-permohonan.component.scss'
})
export class KeputusanKelulusanPermohonanComponent {
