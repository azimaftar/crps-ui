...
@Component({
  selector: 'app-kelulusan-senarai-individu',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './kelulusan-senarai-individu.component.html',
  styleUrls: ['./kelulusan-senarai-individu.component.scss']
})
export class KelulusanSenaraiIndividuComponent {
