...
@Component({
  selector: 'app-kelulusan-maklumat-agensi',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './kelulusan-maklumat-agensi.component.html',
  styleUrls: ['./kelulusan-maklumat-agensi.component.scss'],
})
export class KelulusanMaklumatAgensiComponent {
