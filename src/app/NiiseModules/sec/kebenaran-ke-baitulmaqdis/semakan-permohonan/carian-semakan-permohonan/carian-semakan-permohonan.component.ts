...
@Component({
  selector: 'app-carian-semakan-permohonan',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './carian-semakan-permohonan.component.html',
  styleUrls: ['./carian-semakan-permohonan.component.scss'],
})
export class CarianSemakanPermohonanComponent {
