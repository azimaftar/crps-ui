...
@Component({
  selector: 'app-semakan-maklumat-agensi',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './semakan-maklumat-agensi.component.html',
  styleUrls: ['./semakan-maklumat-agensi.component.scss'],
})
export class SemakanMaklumatAgensiComponent {
