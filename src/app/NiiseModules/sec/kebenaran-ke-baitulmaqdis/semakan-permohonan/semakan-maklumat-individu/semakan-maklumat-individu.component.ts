...
@Component({
  selector: 'app-semakan-maklumat-individu',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './semakan-maklumat-individu.component.html',
  styleUrls: ['./semakan-maklumat-individu.component.scss'],
})
export class SemakanMaklumatIndividuComponent {
