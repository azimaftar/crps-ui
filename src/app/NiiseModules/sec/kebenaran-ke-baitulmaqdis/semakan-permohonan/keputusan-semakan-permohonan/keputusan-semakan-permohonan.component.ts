...
@Component({
  selector: 'app-keputusan-semakan-permohonan',
  imports: [CommonModule, FormsModule],
  templateUrl: './keputusan-semakan-permohonan.component.html',
  styleUrl: './keputusan-semakan-permohonan.component.scss'
})
export class KeputusanSemakanPermohonanComponent {
  ...
  closePopup(form?: NgForm) {
    ...
    if (this.popupType === 'success') {
      ...
      this.currentStep = 3;
      this.router.navigate(['/sec/kebenaran-ke-baitulmaqdis/semakan-permohonan/keputusan-semakan-permohonan']);
    }
  ...
  this.router.navigate([
    '/sec/kebenaran-ke-baitulmaqdis/semakan-permohonan/keputusan-semakan-permohonan',
  ]);
}
}
