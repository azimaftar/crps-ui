...
@Component({
  selector: 'app-maklumat-individu',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './maklumat-individu.component.html',
  styleUrls: ['./maklumat-individu.component.scss'],
})
export class MaklumatIndividuComponent {
  ...
  steps = [
    { number: 1, title: 'Carian Permohonan', route: '/sec/kebenaran-ke-baitulmaqdis/permohonan-baru' },
    { number: 2, title: 'Maklumat Agensi', route: '/sec/kebenaran-ke-baitulmaqdis/permohonan-baru/maklumat-agensi' },
    { number: 3, title: 'Senarai Individu', route: '/sec/kebenaran-ke-baitulmaqdis/permohonan-baru/senarai-individu' },
    { number: 4, title: 'Maklumat Individu', route: '/sec/kebenaran-ke-baitulmaqdis/permohonan-baru/maklumat-individu' },
  ];
