...
@Component({
  selector: 'app-pengesyoran-maklumat-individu',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './pengesyoran-maklumat-individu.component.html',
  styleUrls: ['./pengesyoran-maklumat-individu.component.scss'],
})
export class PengesyoranMaklumatIndividuComponent {
