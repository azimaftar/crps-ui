...
@Component({
  selector: 'app-pengesyoran-senarai-individu',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './pengesyoran-senarai-individu.component.html',
  styleUrls: ['./pengesyoran-senarai-individu.component.scss']
})
export class PengesyoranSenaraiIndividuComponent {
