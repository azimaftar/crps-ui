...
@Component({
  ...
  templateUrl: './tambah-subjek.component.html',
  styleUrl: './tambah-subjek.component.scss'
})

export class TambahSubjekComponent implements OnInit {
  ...
  nextStep(): void {
    ...
    this.router.navigate(['./maklumat-tindakan'], {
