...
@Component({
  selector: 'app-pengesahan-kelewatan-list',
  templateUrl: './pengesahan-kelewatan-list.component.html',
styleUrls: [
    '../../../bkp.scss'
  ] ,
  standalone: true,
...
export class PengesahanKelewatanListComponent {
        ...
        next: (resList: any[]) => {
          ...
          this.arrayOfCutiADMData = this.arrayOfCutiADMData.map((cuti) => {
            ...
            const updatedCuti = {
              ...
              clockInDate: match ? match.clockInDate : cuti.clockInDate,
              clockInTime: match ? match.clockInTime : cuti.clockInTime,
              reviewStatus: match ? match.reviewStatus : cuti.reviewStatus,
            };
